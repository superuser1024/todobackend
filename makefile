...
# Application service name - must match Docker compose release service name
...
# Set DOCKER_REGISTRY_AUTH to auth endpoint for private registry
...
# Not working... needs looking into. The app backend is not starting. works when running seperatley from folders...
# app:
